...
{{--            </div>--}}
            ...
            <div class="left-line">
                <label class="input" id="username">
                    <span>ユーザー名</span>
                    <input type="text" name="username" value="{{ old('username') ?? $data['username'] ?? '' }}" id="settings-username-input"
                    ...
                    <i class="mdi mdi-alert-circle-outline" id="SoxCmdfF" title="ユーザー名には半角英数字と一部の記号(-_.)のみ使用でき、3文字～20文字に設定する必要があります。"></i>
